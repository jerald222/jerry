...
public class Capgemini_scraping {
	...
	public static void Cape_gemini_id(String[] args ) throws InterruptedException, IOException {
		...
		//https://bgv.capgemini.com/External/#/External/login
			...
			//Second method for the capegemini for scraping and screenshots
				...
				driver.findElement(By.xpath("/html/body/app-root/app-main/div[1]/div/div/div/app-home/div[1]/searchby/div/div/div/div[1]/customform/form/div/div[2]/div/field-control/input"))
				.sendKeys(value);
				Thread.sleep(1000);
	    ...
	    // clicking on database
	        ...
	        employment8.click();
	        Thread.sleep(1000);
	        WebElement employment9 = driver.findElement(By.xpath("/html/body/app-root/app-main/div[1]/div/div/div/request/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div/div/check/div[1]/div/div[2]/div/document/div[1]/div/div[1]/div/div[1]/customform/form/div/div[2]/div/label"));
