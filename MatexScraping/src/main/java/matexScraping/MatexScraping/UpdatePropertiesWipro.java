...
public class UpdatePropertiesWipro {
...
//	    		
	//   }
			public static void Wipro_UPDATE(String string) {
	            ...
	            try (FileInputStream input = new FileInputStream(filePath)) {
	                ...
	                properties.setProperty("Wipro_Excel", string);
	                ...
	                System.out.println("Wipro_Excel updated successfully.");
