...
public class ID_Check_Application extends JFrame  {
...
//              	URL url = new URL("http://192.168.0.206:8080/matex2-user-service/auth/login");
                  ...
                  if (responseCode == HttpURLConnection.HTTP_OK) {
                     ...
                     tcspanel1.setVisible(true); 
                 	 ...
                 	 JOptionPane.showMessageDialog(ID_Check_Application.this, "Login successful!");
                  }else if (responseCode == 401){
                      JOptionPane.showMessageDialog(ID_Check_Application.this, " username or password incorrect.");
                    }else if (responseCode == 400){
                    	  JOptionPane.showMessageDialog(ID_Check_Application.this, "Enter username and password.");
                           
                    } else if (responseCode == 503){
                  	  JOptionPane.showMessageDialog(ID_Check_Application.this, "Service unavailable.");
                      ...
                      JOptionPane.showMessageDialog(ID_Check_Application.this, "Login failed.");
                  }

                  con.disconnect();
              } catch (IOException ex) {
                  JOptionPane.showMessageDialog(ID_Check_Application.this, "Error: " + ex.getMessage());
        	 ...
        	 String[] argument = new String[] {"ishwarya.s@matrixbsindia.com","Aug@2023", ""};
        		...
        		try {
        		 ...
        		 try {
        			 ...
        			 TCSExp_Datewise.sample(argument1);
   ...
   public class UploadListener implements ActionListener {
     	...
     	public void actionPerformed(ActionEvent e) {
             ...
             String j = fileChooser.getSelectedFile().toString();
             	...
             	StringtoPass = fileChooser.getSelectedFile().toString();
   ...
   public class UploadListener1 implements ActionListener {
     	...
     	public void actionPerformed(ActionEvent e) {
             ...
             String j = fileChooser1.getSelectedFile().toString();
             	...
             	TcsfileUploadPanel.setVisible(true);
                 //submitPanel.setVisible(true);
             	StringtoPass = fileChooser1.getSelectedFile().toString();
...
public class UploadListenerDirect implements ActionListener {
    ...
    public class submitListener implements ActionListener {
      		...
      		String[] argument = new String[] {"ishwarya.s@matrixbsindia.com","Oct@2023"};
       		...
       		try {
       			TcsExpbackup_candidate.captcha1(argument);
    		} catch (InterruptedException e1) {
...
//                         }     
    ...
    public class capefileuploadsubmitListener implements ActionListener {
		...
		try {
			Capgemini_scraping.Cape_gemini_id(argument);
	} catch (InterruptedException e1) {
 ...
 public class HCLfileuploadsubmitListener implements ActionListener {
       	...
       	public void actionPerformed(ActionEvent e) {
		String[] argument = new String[] {"TPA090","hcl@123",""};
 ...
 public class NivafileuploadsubmitListener implements ActionListener {
	 	...
	 	public void actionPerformed(ActionEvent e) {
			...
			e1.printStackTrace();
	          ...
	          // JFileChooser fileChooser = null;
					// Create a File object that represents the Excel file to read
	           File file1 = new File(StringtoPassNiva);
	               ...
	               if (row != null) {
	                   ...
	                   if (!skipRow) {
	                       ...
	                       if (cell != null) {
	                           ...
	                           // Convert List<String> to a single string with a delimiter (e.g., comma)
	                           String joinedValues = String.join(",", columnValues);
System.out.println(joinedValues+"sbfhdfhbdshfdhfghsdfhdg");
	                           // Create an array with the single string
	                           String[] argument1 = new String[] { joinedValues };

	                           try {
	                               // Call the method with the array argument
	                               NivaBupa_2.NivaBupa_download(argument1);
	                           } catch (InterruptedException | IOException e1) {
	                               e1.printStackTrace();
	                           }
	                       }
...
//	                                DataFormatter formatter = new DataFormatter();
//	                               
//	                                columnValues[0] = String.valueOf(numericValue);
////	                                formatter.formatCellValue(numericValue);
...
//	           }     
 ...
 public class Tech_mahindrafileuploadsubmitListener implements ActionListener {
		...
		System.out.println(Tech_mahindra_username);
			try {
				TechMahindra.TechMahindra1(argument);
		} catch (InterruptedException e1) {
 ...
 public class AccenturefileuploadsubmitListener implements ActionListener {
	 	...
	 	public void actionPerformed(ActionEvent e) {
			String[] argument = new String[] {"ramachandran.rm@accenture.com","Rsubashini@19",""};
 ...
 public class TcssubmitListener1 implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			 String[] argument1 = new String[] {"V.anandamurugan@matrixbsindia.com","Nov@2023",""};
        		
       		try {
       			TCSspecfic_RBCBackup.captchaRBC(argument1 );
    		} catch (InterruptedException e1) {
...
//                 } 
 ...
 public static void main(String[] args) {
        ID_Check_Application gui = new ID_Check_Application();
        gui.setVisible(true);
    }
