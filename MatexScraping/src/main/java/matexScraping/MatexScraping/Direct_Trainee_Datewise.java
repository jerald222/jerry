...
public class Direct_Trainee_Datewise {
...
static	Logger log =Logger.getLogger(Direct_Trainee_Datewise.class);
		...
		//	String[] args = {"userID","password","CandidateId" };	
			...
			DirectTcsDatewise(args);
		
			DirectTcsDatewisemtd(args);
		
		}
	
		public static void DirectTcsDatewise(String[] args) throws InterruptedException, IOException {
...
//		/html/body/div[1]/div[2]/form/table[3]/tbody/tr/td/div/div/table/tbody/tr[1]/td[2]/a
	driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(500));
		...
		public static  void DirectTcsDatewisemtd(String[] args) throws InterruptedException, IOException {
		...
		//**********************select from the list option***********//
			driver.findElement(By.xpath("//*[@id=\"agencySearchViewForm:advanceSearchPanel:j_idt112_panel\"]/div/ul/li[2]")).click();
			//*[@id="agencySearchViewForm:advanceSearchPanel:j_idt112_panel"]/div/ul/li[2]
			driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(500));
			Thread.sleep(2000);
			System.out.println("//****************************select from the list type  ");
		

				// ------------------BGC TYPE Direct traineee----------------------//
				// agencySearchViewForm:checksDatatable:0:j_idt144
				driver.findElement(By.id("agencySearchViewForm:advanceSearchPanel:j_idt105_label")).click();
				driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(500));
				Thread.sleep(2000);
				System.out.println("//****************************Direct trainee trainee type ");
			...
			//Getting selected date from the scrapping application
				//+++++++++++++++++++++Datewise_click++++++++++++++++++++//
...
//					
				 ...
				 //+++++++++++++++++++++Datewise_click done++++++++++++++++++++//
					...
					//listing the No:Rows in the first table
				        ...
				        // Get the number of rows in the outer table						"div.table-responsive>table>tbody>tr"
						...
						Dateapply1.sendKeys(Datewise1);
						 ...
						 if (Datewise1.isEmpty()) {
							...
							// ------------------BGC TYPE----------------------//
							 ...
							 //Direct trainee  element click
								 driver.findElement(By.xpath("//*[@id=\"agencySearchViewForm:advanceSearchPanel:j_idt105_panel\"]/div/ul/li[5]")).click();
							 Thread.sleep(2000);
							 // -----submit button----//
								WebElement element4 = driver.findElement(By.name("agencySearchViewForm:addNewMiddleSubmit"));
								JavascriptExecutor executor3 = (JavascriptExecutor) driver;
