...
public class UpdatePropertiesHCL {
...
//    		
//   }
		public static void HCL_UPDATE(String string) {
            ...
            try (FileInputStream input = new FileInputStream(filePath)) {
                ...
                properties.setProperty("HCL_Excel", string);
                ...
                System.out.println("HCL_Excel updated successfully.");
