...
public class Direct_Trainee {
	
static	Logger log =Logger.getLogger(Direct_Trainee.class);
		...
		//	String[] args = {"userID","password","CandidateId" };	
			...
			DirectTcscaptcha(args);
		
			Directtcssample(args);
		
		}
	
		public static void DirectTcscaptcha(String[] args) throws InterruptedException, IOException {
...
//		/html/body/div[1]/div[2]/form/table[3]/tbody/tr/td/div/div/table/tbody/tr[1]/td[2]/a
	driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(500));
		...
		public static  void Directtcssample(String[] args) throws InterruptedException, IOException {
...
//		            	        }
					   ...
					   WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
						WebElement   OK2  = wait.until((WebDriver kh ) -> ExpectedConditions.elementToBeClickable(OK).apply(kh));
